...
def get_recipe():
    ...
    try:
        ...
        prompt = f"""Create a complete recipe for "{user_input}" in {lang['name']}. Return ONLY valid JSON with this exact shape:
{{
...
{lang['system_prompt']}"""
        ...
        return jsonify({'success': True, 'recipe': recipe_text, 'dish_name': user_input, 'image_url': image_url})
